...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_org(self, org: str, resp: Dict, mock_get: MagicMock) -> None:
        ...
        self.assertEqual(test.org(), resp)
    ...
    def test_public_repos_url(self):
        ...
        with patch('client.GithubOrgClient.org',
            ...
            P_load = {'repos_url': "https://api.github.com/users/google/repos"}
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    """A class that defines integration tests for GithubOrgClient"""
    @classmethod
    def setUpClass(cls) -> None:
        ...
        def test_public_repos_with_license(self) -> None:
            """It tests public_repos with license"""
            self.assertEqual(
